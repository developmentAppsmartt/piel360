...
import { FitzpatrickRulesConfigurator } from "@/components/fitzpatrick-rules/fitzpatrick-rules-configurator";
 ...
 */
export default async function AdminFitzpatrickRulesPage() {
  ...
  const canConfigureClinically =
    permissions.includes("clinical.fitzpatrick_rules") ||
    permissions.includes("clinical.routines");

  if (canConfigureClinically) {
    return <FitzpatrickRulesConfigurator />;
  }
    ...
    <div className="mx-auto max-w-3xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Módulo de parametrización clínica: recomendaciones según el fototipo (Fitzpatrick)
          del paciente.
        </p>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ModuleCardDescription className="mt-2 text-sm leading-relaxed">
              Asigna el permiso <strong>Reglas por fototipo</strong> en Roles y permisos:
