// Port de apps/web/src/lib/survey-questions.ts — mismas 10 keys/opciones que POST /me/survey.
...
export const SURVEY_QUESTIONS: SurveyQuestion[] = [
  {
    ...
    options: [
      {
        value: 'risk_check',
        label: 'Revisión de riesgo de enfermedades cutáneas',
      },
      {
        value: 'mole_monitor',
        label: 'Monitoreo de lunares/detección temprana de cáncer',
      },
